...
public class OfficeDrawing {
	...
	private static void drawSheet1(HSSFSheet sheet1) {
		...
		// Draw a rectangle.
		HSSFSimpleShape rect = patriarch.createSimpleShape(new HSSFClientAnchor(100, 100, 900, 200, (short) 0, 0,
				(short) 0, 0));
	...
	private static void drawSheet4(HSSFSheet sheet4, HSSFWorkbook wb) {
		...
		HSSFTextbox textbox3 = patriarch.createTextbox(new HSSFClientAnchor(0, 0, 900, 100, (short) 4, 4, (short) 5,
				4 + 1));
	...
	private static void drawSheet5(HSSFSheet sheet5, HSSFWorkbook wb) throws IOException {
		...
		patriarch.createPicture(anchor,
				loadPicture(Utils.getResourceFromRoot("excel/example/logoKarmokar4.png").getAbsolutePath(), wb));

		anchor = new HSSFClientAnchor(0, 0, 0, 255, (short) 4, 2, (short) 5, 7);
		anchor.setAnchorType(AnchorType.MOVE_DONT_RESIZE);
		patriarch.createPicture(anchor,
				loadPicture(Utils.getResourceFromRoot("excel/example/logoKarmokar4edited.png").getAbsolutePath(), wb));

		anchor = new HSSFClientAnchor(0, 0, 1023, 255, (short) 6, 2, (short) 8, 7);
		anchor.setAnchorType(AnchorType.MOVE_DONT_RESIZE);
		HSSFPicture picture = patriarch.createPicture(anchor,
				loadPicture(Utils.getResourceFromRoot("excel/example/logoKarmokar4s.png").getAbsolutePath(), wb));
