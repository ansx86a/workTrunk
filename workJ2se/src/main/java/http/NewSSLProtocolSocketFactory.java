...
public class NewSSLProtocolSocketFactory implements ProtocolSocketFactory {
	 ...
	 */
	public NewSSLProtocolSocketFactory() {
		super();
	}
	...
	private static SSLContext createEasySSLContext() {
		try {
			...
			context.init(null, new TrustManager[] { new NewX509TrustManager(null) }, null);
			return context;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public boolean equals(Object obj) {
		return ((obj != null) && obj.getClass().equals(NewSSLProtocolSocketFactory.class));
	}

	public int hashCode() {
		return NewSSLProtocolSocketFactory.class.hashCode();
	}
